...
c.JupyterHub.admin_users = set(['jcchen'])
...
c.JupyterHub.ssl_cert = '/etc/letsencrypt/live/cosbi7.ee.ncku.edu.tw/fullchain.pem'

## Path to SSL key file for the public facing interface of the proxy
#  
#  When setting this, you should also set ssl_cert
c.JupyterHub.ssl_key = '/etc/letsencrypt/live/cosbi7.ee.ncku.edu.tw/privkey.pem'
